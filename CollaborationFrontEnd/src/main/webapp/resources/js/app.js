...
app.config(function($routeProvider) {
	...
	.when('/editProfile', {
		templateUrl : 'UserPages/editProfile.html',
		controller : 'UserController'
	})
	...
	.when('/forumList', {
		templateUrl : 'Chat_Forum/ForumList.html',
		controller : 'ForumController'
	})
	
	.when('/MyforumList', {
		templateUrl : 'Chat_Forum/MyForumList.html',
		controller : 'ForumController'
	})
	
	.when('/viewForumById', {
		templateUrl : 'Chat_Forum/ViewForum.html',
		controller : 'ForumController'
	})
...
app.run(function($rootScope, $location, $cookieStore, $http) {
	...
	$rootScope.selectedForum = $cookieStore.get('selectedForum') || {};
